...
tab_panel_summary <-tabPanel(
  ...
  h3("Summary"),
  br(),
  p("One of our project questions were \"what factors increase the risk of mental health problems for college students?\" By using our dataset that included students with depression and anxiety, we found out
    ...
    was \"Is there a trend between GPA and having a mental health disorder?\" Using the same dataset with students that had depression and anxiety, we saw a trend. The following keypoints are summarized below."),
  h3("Key points: "),
