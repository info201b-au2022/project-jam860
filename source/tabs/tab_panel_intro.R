...
tab_panel_intro <-tabPanel(
    ...
    p("3. Is there a trend between GPA and having a mental health disorder?"),
    h2("Data Analyzed"),
    p("We analyzed a multiude of factors when it comes to the student's mental health.
      ...
      the survey would ask about their GPA and their major. In addition, we also analyzed another survey about self-care. If a student 
    ...
    h2("Key Findings"),
    p("There were several key findings. Aiming for a high GPA while also being in a competitive major contributed to more problems for student's mental health.
